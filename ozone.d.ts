    ...
    */
    class ColumnStore implements ColumnStoreInterface {
        ...
        */
        ...
        public fields(): RandomAccessField<any>[];
        public field(key: string): RandomAccessField<any>;
        public filter(fieldNameOrFilter: any, value?: any): RandomAccessStore;
        public filters(): Filter[];
        public simplifiedFilters(): Filter[];
        public removeFilter(filter: Filter): RandomAccessStore;
        public partition(fieldAny: any): {
            [value: string]: RandomAccessStore;
        };
        public eachRow(rowAction: Function): void;
    }
}
declare module ozone.columnStore {
    ...
    */
    class IndexedField<T> implements RandomAccessField<T> {
        ...
        */
        ...
        public typeConstructor: any;
        private rangeVal;
        constructor(descriptor: FieldDescribing, valueList: T[], valueMap: (valueId: string) => IntSet);
        public allValues(): T[];
        public values(rowToken: any): T[];
        public range(): Range;
        ...
        public intSetForValue(value: any): IntSet;
    }
}
/**
...
declare module ozone.intSet {
    ...
    */
    class ArrayIndexIntSet implements IntSet {
        ...
        public min(): number;
        public max(): number;
        public each(action: (index: number) => void): void;
        public iterator(): OrderedIterator<number>;
        public equals(set: IntSet): boolean;
        public union(set: IntSet): IntSet;
        public intersection(set: IntSet): IntSet;
    }
...
declare module ozone.intSet {
    ...
    */
    class BitmapArrayIntSet implements PackedIntSet {
        ...
        */
        ...
        public has(theBit: number): boolean;
        /**
        ...
        */
        ...
        public iterator(): OrderedIterator<number>;
        /** Iterate over all the packed words in order. */
        public wordIterator(): OrderedWordWithOffsetIterator;
        /** Returns an IntSet containing all the elements in either IntSet. */
        public union(set: IntSet): IntSet;
        /** Returns an IntSet containing only the elements that are found in both IntSets. */
        public intersection(set: IntSet): IntSet;
    ...
    */
    class OrderedBitmapArrayIterator implements OrderedIterator<number> {
        ...
        */
        public next(): number;
        public skipTo(item: number): void;
    }
    /**
...
declare module ozone.intSet {
    ...
    */
    class RangeIntSet implements IntSet {
        ...
        public each(action: (index: number) => void): void;
        public iterator(): OrderedIterator<number>;
        public equals(bm: IntSet): boolean;
        public union(bm: IntSet): IntSet;
        public intersection(bm: IntSet): IntSet;
        public toString(): string;
    }
}
...
declare module ozone.rowStore {
    ...
    */
    ...
    class RangeCalculator extends AbstractReducer<any, Range> {
        ...
        public reset(): void;
        public onItem(rowToken: any): void;
